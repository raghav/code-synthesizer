...
if len(argv) < 4:
    ...
    print('trained weights', argv[0])
    print('trained model', argv[1])
    print('input path', argv[2])
    print('output path', argv[3])
    print('platform', argv[4])
...
model = pix2code(input_shape, output_size, trained_weights_path, voc.size, platform)
